...
that covers every ordinary use, at home or at work. If you need to embed devcoach in a
**closed-source product**, [open an issue](https://github.com/UltimaPhoenix/dev-coach/issues) and ask.

## Contributing

Contributions are welcome under the AGPL; contributors sign a lightweight
[Contributor License Agreement](https://github.com/UltimaPhoenix/dev-coach/blob/main/CLA.md) on their
first pull request. See [CONTRIBUTING](https://github.com/UltimaPhoenix/dev-coach/blob/main/CONTRIBUTING.md)
to get started.
