...
title column takes whatever is left, so shrink the others to give it more room. Widths are remembered
in this browser; double-click a handle to reset that column, or use **⋯ → Reset column widths**.
