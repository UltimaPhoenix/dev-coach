---
title: devcoach
description: Stay sharp while your AI does the work. devcoach is a free, local, open-source MCP server that delivers one short, in-context lesson after every task your AI agent completes — for Claude Code, Cursor, and other MCP tools.
keywords: [devcoach, MCP server, AI coding coach, Claude Code, Cursor, Model Context Protocol, learn while coding, developer learning]
